...
// CelestiaExecTxResult contains results of executing one individual transaction.
//
// * Its structure is equivalent to #ResponseDeliverTx which will be deprecated/deleted
type CelestiaExecTxResult struct {
...
type CelestiaResultTx struct {
	...
	TxResult CelestiaExecTxResult `json:"tx_result"`
	Tx       types.Tx             `json:"tx"`
	Proof    types.TxProof        `json:"proof,omitempty"`
}

// Result of searching for txs
type CelestiaResultTxSearch struct {
